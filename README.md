...
当前版本以原生 SwiftUI 的“家”、聊天和“日子”月历为主体，不再用 `WKWebView` 承载整站。聊天数据、流式回复、照片、录音、工具卡片、旧话搜索和模型设置都走原生视图；网页只在消息本身确实是一张 HTML 卡片时作为内容查看器使用。无第三方依赖。

- 最低系统：iOS 16。
- 第一阶段已统一潮汐背景、半透明卡片、细描边和原生导航，并接入原生“家”仪表盘与“日子”月历；后续再逐页原生化相册和设置。
